...
<section class="header-extradiv">
    <div class="container">
        ...
        <div class=" extra-div col-lg-4 col-md-4 col-12">
            <a href="addProduct.php"><i class="fa-3x fa fa-globe" aria-hidden="true">
            </i></a>
        <h2>Add Product</h2>
        <p>Add New Product</p>
        </div>
        ...
        <div class=" extra-div col-lg-4 col-md-4 col-12">
            <a href="showAllProduct.php"><i class="fa-3x fa fa-paper-plane" aria-hidden="true"></i></a>
        <h2>Show All Product</h2>
        <p>Show All Product Here</p>
        </div>
