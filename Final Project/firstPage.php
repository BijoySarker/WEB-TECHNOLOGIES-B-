...
<body>
	...
	<div class="hero">
		...
		<h3>Farm Food</h3>
		    ...
		    <form id="login" class="input-group" action="Controller/validation.php" method="POST">
				<input type="text" name="user" class="input-field" placeholder="User Name" required>	    	
		    	<input type="password" name="password" class="input-field" placeholder="Enter Password" required>
				<br><br><a href="forgetPassword.php">Forgot Password?</a><br><br>
                <button type="submit" class="submit-btn">Log In</button>
		    </form>
		    <form id="register" class="input-group" action="Controller/registration.php" method="POST">
		    	<input type="text" name="user" class="input-field" placeholder="User Name" required>
